...
- **Estimativa**: abas por cargo (Deputado Federal, Deputado Estadual e majoritários) com a soma do que as lideranças do município devem dar a cada candidato de 2026. O botão "Detalhar" de cada candidato (que vira "Ocultar") expande a relação das lideranças que o apoiam, com votos de 2024, expectativa, estimativa editável, ficha e remoção, além da inclusão de novas lideranças (a estimativa sugerida é a expectativa da liderança) e o total no município. Uma liderança apoia um candidato por cargo; mover para outro pede confirmação.
