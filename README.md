...
- **Lideranças**: lista enxuta com foto, nome, votos em 2024 com os três bairros de maior votação (para quem foi candidato a vereador) e a expectativa de votos em 2026. Todos os candidatos a vereador de 2024 do município entram automaticamente, e é possível incluir lideranças manualmente. "Detalhes" abre um popup com a ficha completa (para quem trabalhou em 2022 para Deputado Estadual e Federal, quem apoiou em 2024 para Prefeito e Vereador, para quem vai trabalhar em 2026 em cada cargo com a estimativa, observações) e o botão Editar.
- **Estimativa**: abas por cargo (Deputado Federal, Deputado Estadual e majoritários) com a soma do que as lideranças do município devem dar a cada candidato de 2026. O botão "Detalhar" de cada candidato (que vira "Ocultar") expande a relação das lideranças que o apoiam, com votos de 2024, expectativa, estimativa editável, ficha e remoção, além da inclusão de novas lideranças (a estimativa sugerida é a expectativa da liderança) e os totais no município e no Ceará. Uma liderança apoia um candidato por cargo; mover para outro pede confirmação.
