...
- Tela **Mapa por bairro**: em cada bairro, um mini gráfico de barras com os 3 mais votados (foto no topo da barra, quantidade de votos e barra na cor do partido, altura relativa ao 1º do bairro); com candidato selecionado, uma barra só com os votos dele. Os quadros são pequenos e sem fundo, ampliam ao passar o cursor e nunca se sobrepõem: a cada zoom o mapa ajusta a escala e afasta quadros que se tocariam, ligando-os ao ponto real do bairro por uma linha tracejada. Clicar no bairro abre o painel de detalhes (pizza com todos os candidatos, totais e lista com "Ver todos"); sem bairro selecionado, o painel mostra "Detalhes gerais" do município.
